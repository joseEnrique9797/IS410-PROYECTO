    ...
    $("#contenido").html(`
        <table id="table-configuracion">
            ...
            <tr>
                ...
                <th class="th-general-espacios" id="th-separador"><a data-toggle="modal" data-target="#exampleModal3" href=""><img id="img-config" src="img/confi.jpg" alt=""></a></th>
                <th class="th-general-espacios">Cambiar los metodos de pago</th>
                <th class="th-general-espacios"><a data-toggle="modal" data-target="#exampleModal4" href=""><img id="img-config" src="img/confi.jpg" alt=""></a></th>
            </tr>
        </table>
    `)
});
...
$("#Right").click(function(){
    ...
    $("#contenido").html(`
        <center><img src="img/grafico_de_barras_apiladas.png" alt=""></center>
    `)
});